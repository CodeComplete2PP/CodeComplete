...
`Code Complete 2판`을 읽고 장별 핵심 내용을 정리하는 저장소입니다.
기존 OS Study GitBook/Jekyll 템플릿을 기반으로 하되, 내용과 설정은 Code Complete 스터디 기준으로 정리했습니다.
...
12주 동안 매주 2~3개 장, 대략 70~80페이지 분량으로 진행합니다.
...
- [홈](./index.md)
- [전체 목차](./_pages/Contents.md)
- [정리 작업 가이드](./CODEX_CHAPTER_WORKING_GUIDE.md)
...
의존성이 이미 설치되어 있으면 `bundle exec jekyll build`로 정적 사이트 빌드를 확인할 수 있습니다.
